...
/**
 * TouchLookArea
 * Invisible full-height zone on the right half of the screen. Tracks
 * finger movement between touch events and accumulates the delta
 * into lookRef, which MobileCameraRig drains and applies as camera
 * rotation each frame.
 */
